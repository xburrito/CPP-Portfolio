...
int main()
{
    ...
    int calculation1 = 6 * 4 + 8 * 4 + 9 / 20; 
  //  It solves first multiplications and divisions and then sums it.
...
//Unless Parenthesis are used to tell the compiler what to calculate first, the order of operations (PEMDAS) will be used.