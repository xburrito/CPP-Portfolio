...
int main() {
  ...
  //test string concatenatio with a C string
  cout << "\n\ns1 += \" to you\" yields\n";
  s1 += " to you";
  cout << "s1 = " << s1;
  
  //test string concatenation with C++14 string-object literal
  ...
  try{
    cout << "Attept to assign 'd' to s1.at(100) yields:\n";
